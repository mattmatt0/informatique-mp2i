...
\begin{document}
	...
	\section{Définitions}
		\subsection{Graphes}
			...
			On parlera, pour désigner les éléments de $E$ dans un graphe non-orienté d'\textbf{arrêtes} du graphe,
			...
			Les \textbf{voisins} de $x$ sont alors ses successeurs et ses prédecesseurs.
