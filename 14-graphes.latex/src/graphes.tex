...
\begin{document}
	...
	\section{Définitions}
		...
		\subsection{Types de graphes}
			...
			\definition Un graphe non-orienté $(V,E)$ est dit bipartie ssi il existe une partition $\set{W_1,W_2}$ de $V$ telle que toutes les arêtes de $E$
	...
	\section{Algorithmes de parcours}
		...
		\subsection{Détection de graphe bipartie.}
			\plabel{Algorithme pour décider si un graphe est bipartie : } Considérons un graphe $G$.
