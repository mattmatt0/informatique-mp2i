...
\newcommand{\warnwip}{\begin{center}\textsl{Ce cours n'est pas encore bien relu}\end{center}}
\newcommand{\warnwipnext}{\begin{center}\textsl{La suite de ce cours est encore en rédaction}\end{center}}
